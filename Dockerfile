...
RUN apk update && \
    ...
    apk add --no-cache dbus firefox git icu-libs libvpx openssl php7 php7-ctype php7-curl php7-dom php7-fpm php7-ftp php7-gd php7-gettext php7-imap php7-iconv php7-json php7-ldap php7-mbstring php7-mcrypt php7-mysqli php7-opcache php7-openssl php7-pdo php7-pdo_mysql php7-phar php7-redis php7-simplexml php7-soap php7-sockets php7-tokenizer php7-xml php7-xmlreader php7-xmlwriter php7-zlib php7-zip postfix py-pip ttf-dejavu xvfb && \
